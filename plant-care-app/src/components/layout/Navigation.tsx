  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-cream-100 border-t border-gray-200 py-3 ">
      <ul className="flex justify-around items-center">
        ...
        <li>
          <Link href="/calendar" className={`flex flex-col items-center ${pathname === '/calendar' ? 'text-green-600' : 'text-gray-500'}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li>
          <Link href="/plants" className={`flex flex-col items-center ${pathname === '/plants' ? 'text-green-600' : 'text-gray-500'}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
            </svg>
            <span className="text-xs mt-1">植物一覧</span>
          </Link>
        </li>
        <li>
          <Link href="/settings" className={`flex flex-col items-center ${pathname === '/settings' ? 'text-green-600' : 'text-gray-500'}`}>
